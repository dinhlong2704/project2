...
import com.example.projectfinal.databinding.HaiphongNotehospitalFragBinding;
...
public class HaiPhongHospitalFrag extends BaseFragment<HaiphongNotehospitalFragBinding, M003HospitalVM> {
    public static final String TAG = HaiPhongHospitalFrag.class.getName();
    ...
    protected void initView() {
        ...
        try {
            viewModel.loadData(context.getAssets().open("hospitalHP.txt"));
        } catch (Exception e) {
    ...
    @Override
    protected HaiphongNotehospitalFragBinding initViewBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        return HaiphongNotehospitalFragBinding.inflate(getLayoutInflater());
    }

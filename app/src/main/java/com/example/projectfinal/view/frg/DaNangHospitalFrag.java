...
public class DaNangHospitalFrag extends BaseFragment<DanangNotehospitalFragBinding, M003HospitalVM> {
    public static final String TAG = DaNangHospitalFrag.class.getName();
    ...
    @Override
    protected DanangNotehospitalFragBinding initViewBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        return DanangNotehospitalFragBinding.inflate(getLayoutInflater());
    }

...
import com.example.projectfinal.databinding.M012MaphospitalBinding;
...
public class MapBoxActivity extends BaseAct<M012MaphospitalBinding, CommonVM> {
    ...
    protected void initView() {
        ...
        speechApi = new MapboxSpeechApi(MapBoxActivity.this, getString(R.string.mapbox_access_token), Locale.US.toLanguageTag());
        mapboxVoiceInstructionsPlayer = new MapboxVoiceInstructionsPlayer(MapBoxActivity.this, Locale.US.toLanguageTag());
        ...
        placeAutocompleteUiAdapter = new PlaceAutocompleteUiAdapter(searchResultsView, placeAutocomplete, LocationEngineProvider.getBestLocationEngine(MapBoxActivity.this));
        ...
        setRoute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MapBoxActivity.this, "Please select a location in map", Toast.LENGTH_SHORT).show();
            }
        });

        mapView.getMapboxMap().

                loadStyleUri(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    @Override
    ...
    @Override
    protected M012MaphospitalBinding initViewBinding() {
        return M012MaphospitalBinding.inflate(getLayoutInflater());
    }
